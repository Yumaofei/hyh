...
object ProcessTimeSlidingWindowDemo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val slide: WindowedStream[(String, String), String, TimeWindow] = keyBy.window(SlidingProcessingTimeWindows.of(Time.seconds(10), Time.seconds(10)))
